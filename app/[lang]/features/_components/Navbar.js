        ...
        <Container maxWidth="lg">
            <Toolbar sx={{
                        ...
                        <List
                            ...
                            subheader={
                                <ListSubheader component="div" id="nested-list-subheader" sx={{
                                    ...
                                    <Icon size='s' />
                                    <Typography variant="button" sx={{ marginLeft: `1rem`, lineHeight: `2.1rem` }}  >{isMobile ? "" : "Horizon"}</Typography>
                                </ListSubheader>
                            }
                        >
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: "start", width: `30%` }}>
                    ...
                    <Typography color="primary" variant="button" sx={{ marginLeft: `1rem` }} >Horizon</Typography>
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: "start", width: `30%` }}>
                </Box>
                <LanguageSwitcher />
